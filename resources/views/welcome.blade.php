...
<body>
    ...
    {{-- Work Process --}}
    <div class="c-container bg-custom-off-white flex flex-col justify-center items-center py-20 gap-8 sm:gap-10 md:gap-12 xl:gap-24">
        ...
        <div class="w-full flex justify-between items-center gap-8 flex-wrap">
            <div class="flex justify-center items-center rounded-full p-8 bg-custom-light-green/20 text-custom-dark-gray shadow-[0px_3.13402px_3.13402px_0px_#5F6342]">
