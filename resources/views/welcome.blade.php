...
<head>
    ...
    <meta name="description" content="WebCreativs - Together, let's turn your website dreams into a reality, say 'Yes' to extraordinary design with us!">
...
<body class="bg-custom-off-white">
    ...
    <div id="hero" class="pt-32 sm:pt-36 md:pt-40 lg:pt-44 xl:pt-40 pb-16 c-container bg-custom-off-white flex flex-col justify-center items-center gap-6 md:gap-10 xl:gap-14">
        ...
        <div class="flex md:gap-6 lg:gap-16 justify-center items-center z-20">
            ...
            <div class="flex flex-col gap-8 justify-center items-center">
                <div class="flex flex-col justify-center items-center gap-2">
                    ...
                    <p class="text-xs sm:text-base md:text-lg xl:text-xl font-libre text-center leading-tight sm:leading-tight md:leading-tight xl:leading-tight text-custom-dark-blue">Create With Us</p>
                </div>
        ...
        <div class="flex justify-center items-center w-full z-20">
            <ul class="flex justify-center flex-wrap items-center w-full list-disc text-xs sm:text-sm md:text-base xl:text-lg font-libre text-center text-custom-dark-blue gap-x-8 md:gap-x-14 xl:gap-x-16 gap-y-6">
                <li class="flex">Personal Website</li>
        ...
        <a href="#about-us" class="text-xs sm:text-sm md:text-base xl:text-lg font-libre text-custom-lightest-green flex flex-col justify-center items-center animate-[bounce_2s_infinite] mt-6 z-20">
            <p class="text-custom-dark-green font-medium text-xs sm:text-sm md:text-base xl:text-lg">Scroll Down</p>
    ...
    <div id="work-process" class="c-container bg-custom-off-white flex flex-col justify-center items-center py-32 gap-8 sm:gap-10 md:gap-12 xl:gap-24">
        ...
        <div class="c-container z-20 content-container">
            <div class="work-process-detail" data-work-process="1">
                <div class="c-container w-full flex flex-col xl:flex-row justify-center items-center bg-white p-6 sm:p-16 md:p-20 lg:p-24 xl:p-28 border border-custom-dark-green rounded-3xl gap-8 sm:gap-12 md:gap-16 lg:gap-20 xl:gap-32">
                    ...
                    <div class="flex flex-col items-center xl:items-start gap-4 text-center xl:text-start">
                        <h1 class="text-custom-light-green font-montserrat font-bold text-sm sm:text-lg md:text:xl xl:text-2xl leading-loose sm:leading-loose md:leading-loose xl:leading-loose">Initial Consultation and Vision</h1>
            ...
            <div class="work-process-detail hidden" data-work-process="2">
                <div class="cc-container w-full flex flex-col xl:flex-row justify-center items-center bg-white p-6 sm:p-16 md:p-20 lg:p-24 xl:p-28 border border-custom-dark-green rounded-3xl gap-8 sm:gap-12 md:gap-16 lg:gap-20 xl:gap-32">
                    ...
                    <div class="flex flex-col items-center xl:items-start gap-4 text-center xl:text-start">
                        <h1 class="text-custom-light-green font-montserrat font-bold text-sm sm:text-lg md:text:xl xl:text-2xl leading-loose sm:leading-loose md:leading-loose xl:leading-loose">Designing UI/UX</h1>
            ...
            <div class="work-process-detail hidden" data-work-process="3">
                <div class="cc-container w-full flex flex-col xl:flex-row justify-center items-center bg-white p-6 sm:p-16 md:p-20 lg:p-24 xl:p-28 border border-custom-dark-green rounded-3xl gap-8 sm:gap-12 md:gap-16 lg:gap-20 xl:gap-32">
                    ...
                    <div class="flex flex-col items-center xl:items-start gap-4 text-center xl:text-start">
                        <h1 class="text-custom-light-green font-montserrat font-bold text-sm sm:text-lg md:text:xl xl:text-2xl leading-loose sm:leading-loose md:leading-loose xl:leading-loose">Design Review and Feedback</h1>
            ...
            <div class="work-process-detail hidden" data-work-process="4">
                <div class="cc-container w-full flex flex-col xl:flex-row justify-center items-center bg-white p-6 sm:p-16 md:p-20 lg:p-24 xl:p-28 border border-custom-dark-green rounded-3xl gap-8 sm:gap-12 md:gap-16 lg:gap-20 xl:gap-32">
                    ...
                    <div class="flex flex-col items-center xl:items-start gap-4 text-center xl:text-start">
                        <h1 class="text-custom-light-green font-montserrat font-bold text-sm sm:text-lg md:text:xl xl:text-2xl leading-loose sm:leading-loose md:leading-loose xl:leading-loose">Project Initiation (50% Payment)</h1>
            ...
            <div class="work-process-detail hidden" data-work-process="5">
                <div class="cc-container w-full flex flex-col xl:flex-row justify-center items-center bg-white p-6 sm:p-16 md:p-20 lg:p-24 xl:p-28 border border-custom-dark-green rounded-3xl gap-8 sm:gap-12 md:gap-16 lg:gap-20 xl:gap-32">
                    ...
                    <div class="flex flex-col items-center xl:items-start gap-4 text-center xl:text-start">
                        <h1 class="text-custom-light-green font-montserrat font-bold text-sm sm:text-lg md:text:xl xl:text-2xl leading-loose sm:leading-loose md:leading-loose xl:leading-loose">Development</h1>
            ...
            <div class="work-process-detail hidden" data-work-process="6">
                <div class="cc-container w-full flex flex-col xl:flex-row justify-center items-center bg-white p-6 sm:p-16 md:p-20 lg:p-24 xl:p-28 border border-custom-dark-green rounded-3xl gap-8 sm:gap-12 md:gap-16 lg:gap-20 xl:gap-32">
                    ...
                    <div class="flex flex-col items-center xl:items-start gap-4 text-center xl:text-start">
                        <h1 class="text-custom-light-green font-montserrat font-bold text-sm sm:text-lg md:text:xl xl:text-2xl leading-loose sm:leading-loose md:leading-loose xl:leading-loose">Domain and Hosting Setup</h1>
            ...
            <div class="work-process-detail hidden" data-work-process="7">
                <div class="cc-container w-full flex flex-col xl:flex-row justify-center items-center bg-white p-6 sm:p-16 md:p-20 lg:p-24 xl:p-28 border border-custom-dark-green rounded-3xl gap-8 sm:gap-12 md:gap-16 lg:gap-20 xl:gap-32">
                    ...
                    <div class="flex flex-col items-center xl:items-start gap-4 text-center xl:text-start">
                        <h1 class="text-custom-light-green font-montserrat font-bold text-sm sm:text-lg md:text:xl xl:text-2xl leading-loose sm:leading-loose md:leading-loose xl:leading-loose">Final Quality Assurance and Delivery</h1>
        ...
        <div class="self-end font-montserrat z-20">
            <p class="text-custom-dark-gray text-xs sm:text-base text-end">**You'll receive project reports every week to stay updated on our progress and milestones.</p>
        </div>
    </div>
