...
<body>
    ...
    {{-- Hero --}}
    <div id="hero" class="pt-40 sm:pt-44 md:pt-48 pb-20 c-container bg-custom-off-white flex flex-col justify-center items-center gap-12 md:gap-10 xl:gap-14">
    ...
    <div class="c-container bg-custom-off-white flex flex-col justify-center items-center py-32 gap-8 sm:gap-10 md:gap-12 xl:gap-24">
        ...
        <div id="work-process-selectors" class="w-full flex justify-between items-center gap-8 flex-wrap">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-16">
                <path stroke-linecap="round" stroke-linejoin="round" d="M17.25 8.25L21 12m0 0l-3.75 3.75M21 12H3" />
            </svg>

            <div class="work-process-selector flex justify-center items-center rounded-full p-8 bg-custom-light-green/20 hover:bg-custom-light-green/30 text-custom-dark-gray shadow-[0px_3.13402px_3.13402px_0px_#5F6342] cursor-pointer transition" onclick="changeWorkProcess(this)" data-work-process="2">
                <svg class="w-12 aspect-square" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="work-process-selector flex justify-center items-center rounded-full p-8 bg-custom-light-green/20 text-custom-dark-gray shadow-[0px_3.13402px_3.13402px_0px_#5F6342] cursor-pointer" onclick="changeWorkProcess(this)" data-work-process="3">
                <svg class="w-12 aspect-square" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="work-process-selector flex justify-center items-center rounded-full p-8 bg-custom-light-green/20 text-custom-dark-gray shadow-[0px_3.13402px_3.13402px_0px_#5F6342] cursor-pointer" onclick="changeWorkProcess(this)" data-work-process="4">
                <svg class="w-12 aspect-square" viewBox="0 0 38 28" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="work-process-selector flex justify-center items-center rounded-full p-8 bg-custom-light-green/20 text-custom-dark-gray shadow-[0px_3.13402px_3.13402px_0px_#5F6342] cursor-pointer" onclick="changeWorkProcess(this)" data-work-process="5">
                <svg class="w-12 aspect-square" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="work-process-selector flex justify-center items-center rounded-full p-8 bg-custom-light-green/20 text-custom-dark-gray shadow-[0px_3.13402px_3.13402px_0px_#5F6342] cursor-pointer" onclick="changeWorkProcess(this)" data-work-process="6">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.2" stroke="currentColor" class="w-12 aspect-square">
            ...
            <div class="work-process-selector flex justify-center items-center rounded-full p-8 bg-custom-light-green/20 text-custom-dark-gray shadow-[0px_3.13402px_3.13402px_0px_#5F6342] cursor-pointer" onclick="changeWorkProcess(this)" data-work-process="7">
                <svg class="w-12 aspect-square" viewBox="0 0 34 38" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="c-container">
            ...
            <div class="work-process-detail hidden" data-work-process="4">
                <div class="c-container w-full flex justify-center items-center bg-white py-24 px-32 border border-custom-dark-green rounded-3xl gap-32">
                    <div class="text-custom-light-green">
                        <svg class="w-32 aspect-square" viewBox="0 0 38 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M25.5625 19.25C25.2144 19.25 24.8806 19.3883 24.6344 19.6344C24.3883 19.8806 24.25 20.2144 24.25 20.5625C24.25 20.9106 24.3883 21.2444 24.6344 21.4906C24.8806 21.7367 25.2144 21.875 25.5625 21.875H30.8125C31.1606 21.875 31.4944 21.7367 31.7406 21.4906C31.9867 21.2444 32.125 20.9106 32.125 20.5625C32.125 20.2144 31.9867 19.8806 31.7406 19.6344C31.4944 19.3883 31.1606 19.25 30.8125 19.25H25.5625ZM0.625 7.4375C0.625 5.69702 1.3164 4.02782 2.54711 2.79711C3.77782 1.5664 5.44702 0.875 7.1875 0.875H30.8125C32.553 0.875 34.2222 1.5664 35.4529 2.79711C36.6836 4.02782 37.375 5.69702 37.375 7.4375V20.5625C37.375 22.303 36.6836 23.9722 35.4529 25.2029C34.2222 26.4336 32.553 27.125 30.8125 27.125H7.1875C5.44702 27.125 3.77782 26.4336 2.54711 25.2029C1.3164 23.9722 0.625 22.303 0.625 20.5625V7.4375ZM34.75 8.75V7.4375C34.75 6.39321 34.3352 5.39169 33.5967 4.65327C32.8583 3.91484 31.8568 3.5 30.8125 3.5H7.1875C6.14321 3.5 5.14169 3.91484 4.40327 4.65327C3.66484 5.39169 3.25 6.39321 3.25 7.4375V8.75H34.75ZM3.25 11.375V20.5625C3.25 21.6068 3.66484 22.6083 4.40327 23.3467C5.14169 24.0852 6.14321 24.5 7.1875 24.5H30.8125C31.8568 24.5 32.8583 24.0852 33.5967 23.3467C34.3352 22.6083 34.75 21.6068 34.75 20.5625V11.375H3.25Z" fill="currentColor" />
                        </svg>
                    </div>
                    <div class="flex flex-col gap-4">
            ...
            <div class="work-process-detail hidden" data-work-process="6">
                <div class="c-container w-full flex justify-center items-center bg-white py-24 px-32 border border-custom-dark-green rounded-3xl gap-32">
                    <div class="text-custom-light-green">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.2" stroke="currentColor" class="w-32 aspect-square">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M12 21a9.004 9.004 0 008.716-6.747M12 21a9.004 9.004 0 01-8.716-6.747M12 21c2.485 0 4.5-4.03 4.5-9S14.485 3 12 3m0 18c-2.485 0-4.5-4.03-4.5-9S9.515 3 12 3m0 0a8.997 8.997 0 017.843 4.582M12 3a8.997 8.997 0 00-7.843 4.582m15.686 0A11.953 11.953 0 0112 10.5c-2.998 0-5.74-1.1-7.843-2.918m15.686 0A8.959 8.959 0 0121 12c0 .778-.099 1.533-.284 2.253m0 0A17.919 17.919 0 0112 16.5c-3.162 0-6.133-.815-8.716-2.247m0 0A9.015 9.015 0 013 12c0-1.605.42-3.113 1.157-4.418" />
                        </svg>
                    </div>
                    <div class="flex flex-col gap-4">
            ...
            <div class="work-process-detail hidden" data-work-process="7">
                <div class="c-container w-full flex justify-center items-center bg-white py-24 px-32 border border-custom-dark-green rounded-3xl gap-32">
                    <div class="text-custom-light-green">
                        <svg class="w-32 aspect-square" viewBox="0 0 34 38" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M22.875 33.6738L19.4756 30.2744L17.625 32.125L22.875 37.375L33.375 26.875L31.5244 25.0244L22.875 33.6738Z" fill="currentColor" />
                            <path d="M26.8125 4.5625H22.875V3.25C22.8729 2.55445 22.5957 1.88797 22.1039 1.39614C21.612 0.904306 20.9456 0.627077 20.25 0.625H9.75C9.05445 0.627077 8.38797 0.904306 7.89614 1.39614C7.40431 1.88797 7.12708 2.55445 7.125 3.25V4.5625H3.1875C2.49195 4.56458 1.82547 4.84181 1.33364 5.33364C0.841806 5.82547 0.564577 6.49195 0.5625 7.1875V34.75C0.564577 35.4456 0.841806 36.112 1.33364 36.6039C1.82547 37.0957 2.49195 37.3729 3.1875 37.375H15V34.75H3.1875V7.1875H7.125V11.125H22.875V7.1875H26.8125V21.625H29.4375V7.1875C29.4354 6.49195 29.1582 5.82547 28.6664 5.33364C28.1745 4.84181 27.5081 4.56458 26.8125 4.5625ZM20.25 8.5H9.75V3.25H20.25V8.5Z" fill="currentColor" />
                        </svg>
                    </div>
