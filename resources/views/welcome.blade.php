...
<body>
    ...
    {{-- Hero --}}
    <div id="hero" class="pt-32 sm:pt-36 md:pt-40 lg:pt-44 xl:pt-48 pb-20 c-container bg-custom-off-white flex flex-col justify-center items-center gap-12 md:gap-10 xl:gap-14">
        ...
        <div class="flex gap-16 justify-center items-center z-20">
            ...
            <div class="flex flex-col gap-8 justify-center items-center">
                <div class="flex flex-col justify-center items-center gap-2">
                    ...
                    <p class="text-base sm:text-lg md:text-xl xl:text-2xl font-libre text-center leading-tight sm:leading-tight md:leading-tight xl:leading-tight text-custom-dark-blue">Create With Us</p>
                </div>

                <h1 class="text-3xl sm:text-4xl md:text-5xl xl:text-6xl font-bold font-libre text-center leading-tight sm:leading-tight md:leading-tight lg:leading-tight xl:leading-tight 2xl:leading-tight text-custom-dark-gray">
    ...
    <div id="work-process" class="c-container bg-custom-off-white flex flex-col justify-center items-center py-32 gap-8 sm:gap-10 md:gap-12 xl:gap-24">
        ...
        <div id="work-process-selectors" class="w-full flex justify-center items-center gap-4 md:gap-6 xl:gap-8 flex-wrap z-20">
            <div class="active work-process-selector flex justify-center items-center rounded-full p-3 sm:p-4 md:p-6 lg:p-7 xl:p-9 bg-white text-custom-light-green shadow-[0px_3.13402px_3.13402px_0px_#5F6342] cursor-pointer transition" onclick="changeWorkProcess(this)" data-work-process="1">
                <svg class="w-4 sm:w-6 md:w-8 lg:w-10 xl:w-12 aspect-square" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-6 sm:w-8 md:w-12 xl:w-16">
                <path stroke-linecap="round" stroke-linejoin="round" d="M17.25 8.25L21 12m0 0l-3.75 3.75M21 12H3" />
            </svg>

            <div class="work-process-selector flex justify-center items-center rounded-full p-3 sm:p-4 md:p-6 lg:p-7 xl:p-9 bg-custom-light-green/20 hover:bg-custom-light-green/30 text-custom-dark-gray shadow-[0px_3.13402px_3.13402px_0px_#5F6342] cursor-pointer transition" onclick="changeWorkProcess(this)" data-work-process="2">
                <svg class="w-4 sm:w-6 md:w-8 lg:w-10 xl:w-12 aspect-square" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="work-process-selector flex justify-center items-center rounded-full p-3 sm:p-4 md:p-6 lg:p-7 xl:p-9 bg-custom-light-green/20 text-custom-dark-gray shadow-[0px_3.13402px_3.13402px_0px_#5F6342] cursor-pointer" onclick="changeWorkProcess(this)" data-work-process="3">
                <svg class="w-4 sm:w-6 md:w-8 lg:w-10 xl:w-12 aspect-square" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="work-process-selector flex justify-center items-center rounded-full p-3 sm:p-4 md:p-6 lg:p-7 xl:p-9 bg-custom-light-green/20 text-custom-dark-gray shadow-[0px_3.13402px_3.13402px_0px_#5F6342] cursor-pointer" onclick="changeWorkProcess(this)" data-work-process="4">
                <svg class="w-4 sm:w-6 md:w-8 lg:w-10 xl:w-12 aspect-square" viewBox="0 0 38 28" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="work-process-selector flex justify-center items-center rounded-full p-3 sm:p-4 md:p-6 lg:p-7 xl:p-9 bg-custom-light-green/20 text-custom-dark-gray shadow-[0px_3.13402px_3.13402px_0px_#5F6342] cursor-pointer" onclick="changeWorkProcess(this)" data-work-process="5">
                <svg class="w-4 sm:w-6 md:w-8 lg:w-10 xl:w-12 aspect-square" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="work-process-selector flex justify-center items-center rounded-full p-3 sm:p-4 md:p-6 lg:p-7 xl:p-9 bg-custom-light-green/20 text-custom-dark-gray shadow-[0px_3.13402px_3.13402px_0px_#5F6342] cursor-pointer" onclick="changeWorkProcess(this)" data-work-process="6">
            ...
            <div class="work-process-selector flex justify-center items-center rounded-full p-3 sm:p-4 md:p-6 lg:p-7 xl:p-9 bg-custom-light-green/20 text-custom-dark-gray shadow-[0px_3.13402px_3.13402px_0px_#5F6342] cursor-pointer" onclick="changeWorkProcess(this)" data-work-process="7">
                <svg class="w-4 sm:w-6 md:w-8 lg:w-10 xl:w-12 aspect-square" viewBox="0 0 34 38" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="c-container z-20">
            <div class="work-process-detail" data-work-process="1">
                <div class="c-container w-full flex flex-col xl:flex-row justify-center items-center bg-white p-12 sm:p-16 md:p-20 lg:p-24 xl:p-28 border border-custom-dark-green rounded-3xl gap-8 sm:gap-12 md:gap-16 lg:gap-20 xl:gap-32">
                    ...
                    <div class="flex flex-col items-center xl:items-start gap-4 text-center xl:text-start">
                        <h1 class="text-custom-light-green font-montserrat font-bold text-lg sm:text-xl md:text:2xl xl:text-3xl leading-loose sm:leading-loose md:leading-loose xl:leading-loose">Initial Consultation and Vision</h1>
            ...
            <div class="work-process-detail hidden" data-work-process="2">
                <div class="cc-container w-full flex flex-col xl:flex-row justify-center items-center bg-white p-12 sm:p-16 md:p-20 lg:p-24 xl:p-28 border border-custom-dark-green rounded-3xl gap-8 sm:gap-12 md:gap-16 lg:gap-20 xl:gap-32">
                    ...
                    <div class="flex flex-col items-center xl:items-start gap-4 text-center xl:text-start">
                        <h1 class="text-custom-light-green font-montserrat font-bold text-lg sm:text-xl md:text:2xl xl:text-3xl leading-loose sm:leading-loose md:leading-loose xl:leading-loose">Designing UI/UX</h1>
            ...
            <div class="work-process-detail hidden" data-work-process="3">
                <div class="cc-container w-full flex flex-col xl:flex-row justify-center items-center bg-white p-12 sm:p-16 md:p-20 lg:p-24 xl:p-28 border border-custom-dark-green rounded-3xl gap-8 sm:gap-12 md:gap-16 lg:gap-20 xl:gap-32">
                    ...
                    <div class="flex flex-col items-center xl:items-start gap-4 text-center xl:text-start">
                        <h1 class="text-custom-light-green font-montserrat font-bold text-lg sm:text-xl md:text:2xl xl:text-3xl leading-loose sm:leading-loose md:leading-loose xl:leading-loose">Design Review and Feedback</h1>
            ...
            <div class="work-process-detail hidden" data-work-process="4">
                <div class="cc-container w-full flex flex-col xl:flex-row justify-center items-center bg-white p-12 sm:p-16 md:p-20 lg:p-24 xl:p-28 border border-custom-dark-green rounded-3xl gap-8 sm:gap-12 md:gap-16 lg:gap-20 xl:gap-32">
                    ...
                    <div class="flex flex-col items-center xl:items-start gap-4 text-center xl:text-start">
                        <h1 class="text-custom-light-green font-montserrat font-bold text-lg sm:text-xl md:text:2xl xl:text-3xl leading-loose sm:leading-loose md:leading-loose xl:leading-loose">Project Initiation (50% Payment)</h1>
            ...
            <div class="work-process-detail hidden" data-work-process="5">
                <div class="cc-container w-full flex flex-col xl:flex-row justify-center items-center bg-white p-12 sm:p-16 md:p-20 lg:p-24 xl:p-28 border border-custom-dark-green rounded-3xl gap-8 sm:gap-12 md:gap-16 lg:gap-20 xl:gap-32">
                    ...
                    <div class="flex flex-col items-center xl:items-start gap-4 text-center xl:text-start">
                        <h1 class="text-custom-light-green font-montserrat font-bold text-lg sm:text-xl md:text:2xl xl:text-3xl leading-loose sm:leading-loose md:leading-loose xl:leading-loose">Development</h1>
            ...
            <div class="work-process-detail hidden" data-work-process="6">
                <div class="cc-container w-full flex flex-col xl:flex-row justify-center items-center bg-white p-12 sm:p-16 md:p-20 lg:p-24 xl:p-28 border border-custom-dark-green rounded-3xl gap-8 sm:gap-12 md:gap-16 lg:gap-20 xl:gap-32">
                    ...
                    <div class="flex flex-col items-center xl:items-start gap-4 text-center xl:text-start">
                        <h1 class="text-custom-light-green font-montserrat font-bold text-lg sm:text-xl md:text:2xl xl:text-3xl leading-loose sm:leading-loose md:leading-loose xl:leading-loose">Domain and Hosting Setup</h1>
            ...
            <div class="work-process-detail hidden" data-work-process="7">
                <div class="cc-container w-full flex flex-col xl:flex-row justify-center items-center bg-white p-12 sm:p-16 md:p-20 lg:p-24 xl:p-28 border border-custom-dark-green rounded-3xl gap-8 sm:gap-12 md:gap-16 lg:gap-20 xl:gap-32">
                    ...
                    <div class="flex flex-col items-center xl:items-start gap-4 text-center xl:text-start">
                        <h1 class="text-custom-light-green font-montserrat font-bold text-lg sm:text-xl md:text:2xl xl:text-3xl leading-loose sm:leading-loose md:leading-loose xl:leading-loose">Final Quality Assurance and Delivery</h1>
